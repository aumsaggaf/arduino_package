...
class Controller:
	...
	def joyCb(self, msg):
		...
		# If button 8 on joystick is pressed
		if msg.buttons[7] > 0:
			gp_pub.publish(True)

		# If button 9 on joystick is pressed
		#if msg.buttons[8] > 0:
		#	lv_pub.publish(True)
...
def main():
    ...
    # Gripper publishers
	gp_pub = rospy.Publisher(grip', Bool, queue_size=1)
	#v_pub = rospy.Publisher('leave', Bool)
